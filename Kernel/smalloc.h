...
#define OFFSET    1024
#define SZREG_log 10    //SZREG_log deve ser um numero igual a Log2(OFFSET). Ex: Log2(32) = 5
#define SIZEMEM   7168 //3960
#define NBITMASK  3
...
static uint8_t  TB2[NBITMASK] = {                        3,   4,   5 };      // Define o tamanho dos blocos de cada regiao - 2o nivel

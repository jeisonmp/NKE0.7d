...
#define SZREG     512
#define SZREG_log 9    //SZREG_log deve ser um numero igual a Log2(SZREG). Ex: Log2(32) = 5
#define SIZEMEM   4000 //3960
#define NBITMASK  5
...
static uint8_t  TB2[NBITMASK] = {             4,   5,   5 };      // Define o tamanho dos blocos de cada regiao - 2o nivel
                               //64,128,256,512,1024,2048, 4096
/*
 * CONSTANTES - NAO CONFIGURAVEIS
 */
//#define SMALLOCNULL (void*)NULL
#define SMALLOCNULL (void*)0x00000000
